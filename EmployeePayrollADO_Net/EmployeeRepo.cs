...
namespace EmployeePayrollADO_Net
{
    ...
    {
        public static string connectionString = @"Data Source=AKSHATA-123\SQLEXPRESS;Initial Catalog = PayrollService; Integrated Security = True";
        ...
        public void AddEmployee(EmpModel employee)     //UC3 Insertion into Table .
        {
            try
            {
                using (this.connection)
